...
namespace RegiXServiceReference
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://egov.bg/RegiX", ConfigurationName="RegiXServiceReference.IRegiXEntryPointV2")]
    public interface IRegiXEntryPointV2
    {
        ...
        System.Threading.Tasks.Task<RegiXServiceReference.ResultWrapper> ExecuteAsync(RegiXServiceReference.RequestWrapper request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(AccessMatrixType))]
        System.Threading.Tasks.Task<RegiXServiceReference.ResultWrapper> CheckResultAsync(RegiXServiceReference.ServiceCheckResultWrapper argument);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(AccessMatrixType))]
        System.Threading.Tasks.Task AcknowledgeResultReceivedAsync(RegiXServiceReference.ServiceCheckResultWrapper argument);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(AccessMatrixType))]
        System.Threading.Tasks.Task ExecuteCallbackAsync(RegiXServiceReference.ResultWrapper request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface IRegiXEntryPointV2Channel : RegiXServiceReference.IRegiXEntryPointV2, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class RegiXEntryPointV2Client : System.ServiceModel.ClientBase<RegiXServiceReference.IRegiXEntryPointV2>, RegiXServiceReference.IRegiXEntryPointV2
    {
        ...
        public System.Threading.Tasks.Task<RegiXServiceReference.ResultWrapper> ExecuteAsync(RegiXServiceReference.RequestWrapper request)
        {
            return base.Channel.ExecuteAsync(request);
        }
        
        public System.Threading.Tasks.Task<RegiXServiceReference.ResultWrapper> CheckResultAsync(RegiXServiceReference.ServiceCheckResultWrapper argument)
        {
            return base.Channel.CheckResultAsync(argument);
        }
        
        public System.Threading.Tasks.Task AcknowledgeResultReceivedAsync(RegiXServiceReference.ServiceCheckResultWrapper argument)
        {
            return base.Channel.AcknowledgeResultReceivedAsync(argument);
        }
        
        public System.Threading.Tasks.Task ExecuteCallbackAsync(RegiXServiceReference.ResultWrapper request)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.WSHttpBinding_IRegiXEntryPointV2))
            {
                return new System.ServiceModel.EndpointAddress("https://service-regix-test.egov.bg/RegiXEntryPointV2.svc");
            }
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IRegiXEntryPointV2))
            {
                return new System.ServiceModel.EndpointAddress("https://service-regix-test.egov.bg/RegiXEntryPointV2.svc/basic");
            }
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IRegiXEntryPointV21))
            {
                return new System.ServiceModel.EndpointAddress("https://service-regix-test.egov.bg/RegiXEntryPointV2.svc/serviceBus");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
