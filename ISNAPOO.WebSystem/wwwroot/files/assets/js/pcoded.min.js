...
$.fn.pcodedmenu = function(settings) {
    ...
    var defaults = {
        ...
        LHeaderBackground: 'theme2', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        NavbarBackground: 'theme2', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        ActiveItemBackground: 'theme11', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        SubItemBackground: 'theme2', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        ActiveItemStyle: 'style0',
        ItemBorder: true,
        ItemBorderStyle: 'dotted', // value should be solid/dotted/dashed
        SubItemBorder: true,
        ...
        HandleThemeBackground: function() {
            ...
            function setactiveitemtheme() {
                ...
                if (ev != undefined && ev != "") {
                    ...
                    $('#' + oid + ' .pcoded-navbar').attr("active-item-theme", "theme5");
                }
            };
