...
{
    public partial class CandidateProviderTrainerDocumentModal : BlazorBaseComponent
    {
        ...
        public async Task OpenModal(CandidateProviderTrainerDocumentVM candidateProviderTrainerDocumentVM, IEnumerable<KeyValueVM> kvDocumentTypeSource)
        {
            ...
            this.kvDocumentTypeSource = kvDocumentTypeSource.OrderBy(x => x.Order).ToList();
        ...
        {
            var result = await this.UploadFileService.RemoveFileByIdAndFileNameAsync<CandidateProviderTrainerDocument>(this.candidateProviderTrainerDocumentVM.IdCandidateProviderTrainerDocument, this.fileNameForDeletion);
