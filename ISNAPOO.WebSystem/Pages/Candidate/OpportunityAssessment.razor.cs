...
{
    public partial class OpportunityAssessment : BlazorBaseComponent
    {
        [Parameter]
        ...
        {
            this.kvDocTypeApplication9ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application9").Result.Description;

            this.kvDocTypeApplication10ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application10").Result.Description;

            this.kvDocTypeApplication11ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application11").Result.Description;

            this.kvDocTypeApplication13ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application13").Result.Description;

            this.kvDocTypeApplication14ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application14").Result.Description;

            this.kvDocTypeApplication15ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application15").Result.Description;

            this.kvDocTypeApplication16ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application16").Result.Description;

            this.kvDocTypeApplication17ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application17").Result.Description;

            this.kvDocTypeApplication18ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application18").Result.Description;

            this.kvDocTypeApplication19ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application19").Result.Description;

            this.kvDocTypeApplication20ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application20").Result.Description;

            this.kvDocTypeApplication21ToolTip = dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application21").Result.Description;
        }
        private async Task Application9()
        {
            ...
            try
            {
                ...
                var kvDocTypeApplication9 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application9");
        ...
        private async Task Application10()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication10 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application10");
        ...
        private async Task Application11()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication11 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application11");
        ...
        private async Task Application13()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication13 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application13");
        ...
        private async Task Application14()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication14 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application14");
        ...
        private async Task Application15()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication15 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application15");
        ...
        private async Task Application16()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication16 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application16");
        ...
        private async Task Application17()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication17 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application17");
        ...
        private async Task Application18()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication18 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application18");
        ...
        private async Task Application19()
        {
            ...
            try
            {
                ...
                var model = new ProcedureDocumentVM();        
                    ...
                    var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                    resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                    var kvDocTypeApplication19 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application19");
        ...
        private async Task Application20()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication20 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application20");
        ...
        private async Task Application21()
        {
            ...
            try
            {
                ...
                var model = new ProcedureDocumentVM();
                model.IdStartedProcedure = this.CandidateProviderVM.IdStartedProcedure.Value;
                var commisionId = (await this.providerService.GetStartedProcedureExpertCommissionByIdAsync(model.IdStartedProcedure)).Select(x => x.IdExpertCommission).First();
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication21 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "Application21");
                if (membersfExpertCommission.Count() >= 2 && strainerOfExpertCommission != null)
                {
                ...
                {
                    toast.sfErrorToast.Content = "Липсват членове на ЕК!";
                    await toast.sfErrorToast.ShowAsync();
                }
            }
            finally
