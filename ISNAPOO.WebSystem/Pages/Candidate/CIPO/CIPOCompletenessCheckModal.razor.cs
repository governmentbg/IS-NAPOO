...
{
    public partial class CIPOCompletenessCheckModal : BlazorBaseComponent
    {
        [Parameter]
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            this.professionalDirectionSource = await this.professionalDirectionService.GetCIPOProfessionalDirectionsAsync(new ProfessionalDirectionVM());
            this.procedureExternalExpert.IdProfessionalDirection = professionalDirectionSource.FirstOrDefault(d => d.Code == "999").IdProfessionalDirection;
            this.externalExpertDatasource = await this.expertService.GetAllExpertsAsync(new ExpertVM() { IdProfessionalDirectionFilter = this.procedureExternalExpert.IdProfessionalDirection.Value });
            ...
            this.addedExpertGridSource = this.addedExpertGridSource.OrderBy(x => x.ProfessionalDirection.DisplayNameAndCode);
            ...
            this.expertCommissionValues = (await this.dataSourceService.GetKeyValuesByKeyTypeIntCodeAsync("ExpertCommission")).Where(c => c.Name.Contains("17. Професионално ориентиране")).ToList();
        ...
        private async Task PrintReportPositive()
        {
            ...
            var kvDocTypeApplication1 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application1");
            var kvDocTypeApplication2 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application2");
        ...
        private async Task Application3()
        {
            ...
            try
            {
                ...
                var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
                resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
                var kvDocTypeApplication3 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application3");
                var kvDocTypeApplication2 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application2");
        ...
        private async Task Application4()
        {
            ...
            var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
            resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
            var kvDocTypeApplication4 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application4");
        ...
        private async Task Application5()
        {
            ...
            var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
            resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
            var kvDocTypeApplication5 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application5");
            var kvDocTypeApplication3 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application3");
        ...
        private async Task PrintReportNegative()
        {
            ...
            var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
            resultContext.ResultContextObject = new List<ProcedureDocumentVM>();
            var kvDocTypeApplication6 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application6");
            var kvDocTypeApplication7 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application7");
        ...
        {
            this.externalExpertsReport.OpenModal(procedureExternalExpert.IdProfessionalDirection, procedureExternalExpert.IdExpert, this.CandidateProviderVM.IdCandidate_Provider, "CIPO");
        }
        private async Task OpenExpertCommissionsReport()
        {
            this.expertCommissionsReport.OpenModal(this.idExpertCommission, "CIPO");
        }
        ...
        private async Task LicenseDenial()
        {
            ...
            var resultContext = new ResultContext<List<ProcedureDocumentVM>>();
            var kvDocTypeApplication8 = await dataSourceService.GetKeyValueByIntCodeAsync("ProcedureDocumentType", "CIPO_Application8");
        ...
        private async Task PrintDocumentVE(ProcedureExternalExpertVM externalExpertVM)
        {
            ...
            string[] fieldValues = new string[]
            {
                ...
                Expert.Person.Location == null ? "" :Expert.Person.Location.kati,
                Expert.Person.Location == null ? "" :Expert.Person.Location.LocationName,
                Expert.Person.Location == null ? "" :Expert.Person.Location.Municipality.MunicipalityName,
                Expert.Person.Location == null ? "" :Expert.Person.Location.Municipality.District.DistrictName,
        ...
        private async Task PrintDocumentDeclarationExpertCommission()
        {
            ...
            string CommissionName = (await this.dataSourceService.GetKeyValueByIdAsync(idExpertCommission)).Name;
        ...
        private async Task RequestedMoreDocumentsStep()
        {
            ...
            try
            {
                ...
                if (!persons.Any())
                {
                    await this.ShowErrorAsync("Няма потребители, които са избрани за получаване на известия към това ЦИПО!");
                }
                else
                {
