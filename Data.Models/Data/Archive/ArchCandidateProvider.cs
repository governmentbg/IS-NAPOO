...
namespace Data.Models.Data.Archive
{
    ...
    /// <summary>
    /// АРХИВ CPO,CIPO - Кандидат Обучаваща институция, Заявление
    /// </summary>
    [Table("Arch_Candidate_Provider")]
    [Display(Name = "АРХИВ CPO,CIPO - Обучаваща институция")]
    public class ArchCandidateProvider : AbstractUploadFile, IEntity, IModifiable, IDataMigration
    {
        public ArchCandidateProvider()
        {
            this.UploadedFileName = string.Empty;
            this.ProviderName = $"ЦПО към {ProviderOwner}";            
            this.CandidateProviderTrainers = new HashSet<ArchCandidateProviderTrainer>();
            this.CandidateProviderPremises = new HashSet<ArchCandidateProviderPremises>();
            this.CandidateProviderSpecialities = new HashSet<ArchCandidateProviderSpeciality>();
        }


        [Key]
        public int IdArchCandidateProvider { get; set; }
        public int IdEntity => IdArchCandidateProvider;
        ...
        public virtual ICollection<ArchCandidateProviderTrainer> CandidateProviderTrainers { get; set; }
        public virtual ICollection<ArchCandidateProviderPremises> CandidateProviderPremises { get; set; }
        public virtual ICollection<ArchCandidateProviderSpeciality> CandidateProviderSpecialities { get; set; }
