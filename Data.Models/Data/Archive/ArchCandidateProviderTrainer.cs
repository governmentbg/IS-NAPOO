...
namespace Data.Models.Data.Archive
{
    ...
    public class ArchCandidateProviderTrainer : IEntity, IModifiable, IDataMigration
    {
        public ArchCandidateProviderTrainer()
        {
            this.FirstName = string.Empty;
            this.SecondName = string.Empty;
            this.FamilyName = string.Empty;
          
            this.CandidateProviderTrainerQualifications = new HashSet<ArchCandidateProviderTrainerQualification>();          
        }

        [Key]
        public int IdArchCandidateProviderTrainer { get; set; }

        public int IdEntity => IdArchCandidateProviderTrainer;
        ...
        public virtual ICollection<ArchCandidateProviderTrainerQualification> CandidateProviderTrainerQualifications { get; set; }
