...
namespace Data.Models.Migrations
{
    ...
    [Migration("20230103145052_AlterTable_CourseTopic_AddColumns_TaughtTheoryHours_TaughtPracticeHours")]
    partial class AlterTable_CourseTopic_AddColumns_TaughtTheoryHours_TaughtPracticeHours
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.Data.Training.CourseRequiredDocument", b =>
                {
                    b.Property<int>("IdCourseRequiredDocument")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdCourseRequiredDocument"), 1L, 1);
                    ...
                    b.Property<int>("IdCourseRequiredDocumentType")
                        .HasColumnType("int")
                        .HasComment("Тип задължителни документи за курс");
                    ...
                    b.HasKey("IdCourseRequiredDocument");

                    b.HasIndex("IdCourse");

                    b.ToTable("Training_CourseRequiredDocument");

                    b.HasComment("Необходими документи за курс");
                });
            ...
            modelBuilder.Entity("Data.Models.Data.Training.CourseSubjectGrade", b =>
                {
                    ...
                    b.Property<double?>("Grade")
                        .HasColumnType("float")
                        .HasComment("Обща оценка по предмет от учебен план");
            ...
            modelBuilder.Entity("Data.Models.Data.Training.CourseTopic", b =>
                {
                    b.Property<int>("IdCourseTopic")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdCourseTopic"), 1L, 1);
                    ...
                    b.Property<double>("TaughtPracticeHours")
                        .HasColumnType("float")
                        .HasComment("Сумарен брой преподадени часове по практика");

                    b.Property<double>("TaughtTheoryHours")
                        .HasColumnType("float")
                        .HasComment("Сумарен брой преподадени часове по теория");
                    ...
                    b.HasKey("IdCourseTopic");

                    b.HasIndex("IdCourse");

                    b.ToTable("Training_CourseTopic");
                });
            ...
            modelBuilder.Entity("Data.Models.Data.Training.CourseSchedule", b =>
                {
                    ...
                    b.HasOne("Data.Models.Data.Training.CourseTopic", "CourseTopic")
                        .WithMany("CourseSchedules")
                        .HasForeignKey("IdCourseTopic")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
